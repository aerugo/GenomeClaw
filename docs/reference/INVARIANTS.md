...
2. **The host-side `genomeclaw-service`** — the local HTTP surface the plugin reads (`127.0.0.1:8645` on the host machine; 8643 is DevRelClaw's port). Not technically remote, but listed for clarity.
