...
| 4 — Live verification | **Complete (architectural)** | 2026-05-23 | 2026-05-24 | Architecture verified live: compute reaches `running`, bcftools active inside worker container, Tier 1 mpileup producing output (208 GB cumulative reads, 6.9 MB tier1.vcf.gz after 1 h). AC6 + AC7 met. Green-percentile demo (AC1+AC2) deferred to operator-side ~4-8 h wall on macOS-virtiofs; recommended commands in phase-4.md. Bottleneck = virtiofs throughput, NOT the architectural fix. |
